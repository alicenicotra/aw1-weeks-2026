...
- Review the SQLite database developed last week (Week 03), in Exercise 2, and the related code. If any SQL query is still missing in the code, complete it.
