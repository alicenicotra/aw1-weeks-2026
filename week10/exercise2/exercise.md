# Exercise 9: React meets Express - part I

_Goal: Start connecting the "HeapOverrun" React Client and the API Server._

Starting from the React application developed in the last weeks and the API Server in Express developed in Week 05, make the React application consume some of the APIs to get the content.
